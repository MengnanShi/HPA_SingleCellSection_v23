...
dataBulk = readTXTfile(file.path(basepath,"data","hpa_dataBlood.txt"),1)

# read single cell data
dataSC = readTXTfile(file.path(basepath,"data","hpa_sc_celltype_ntpm_panglao.txt"),1)
...
writeTXTfile(allCounts_DWLS, paste0(basepath,"results_hpa_panglao/","allCounts_DWLS_blood.txt"))
writeTXTfile(allCounts_OLS, paste0(basepath,"results_hpa_panglao/","allCounts_OLS_blood.txt"))
writeTXTfile(allCounts_SVR, paste0(basepath,"results_hpa_panglao/","allCounts_SVR_blood.txt"))
